...
void Sep::CutTranslate::get_sparse_row(const CCtsp_lpcut_in &cc_cut,
...
// int Sep::CutTranslate::get_sparse_row(const HyperGraph &H, vector<int> &rmatind,
// 				 vector<double> &rmatval, char &sense,
// 				 double &rhs)
// {
//     int rval = 0;
...
//  CLEANUP:
//     if (rval) {
//         cerr << "Sep::CutTranslate<HyperGraph>::get_sparse_row failed, "
//              << "row is invalid\n";
//         rmatind.clear();
//         rmatval.clear();
//     }
